...
// Customer-facing availability derived solely from product status. We never
// present these as physically stocked in Nigeria — the catalogue is a sourcing
// catalogue, so the label reflects that the product can be sourced on request.
function toAvailability(status) {
  if (status === 'active') {
