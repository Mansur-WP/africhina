...
const FAQS = [
  {
    question: 'How do I submit a custom product sourcing request?',
    answer:
      'Navigate to Requests and click "New Sourcing Request" or select "Request Quote" from any product in the catalogue. Tell us the product specifications, desired quantity, and destination. Our team in China will contact verified suppliers and prepare a detailed offer for you.',
  },
  {
    question: 'How long does it take to receive a sourcing offer?',
    answer:
      'Our team in China reviews specifications and prepares an offer as quickly as possible. Response times may vary depending on the product and supplier availability. The offer includes unit cost, shipping, inspection, customs estimate, and delivery timeline.',
  },
  {
    question: 'How do I pay for my order?',
    answer:
      'Once you accept a sourcing offer or check out from your direct-sale cart, your order is generated. Payments are processed securely through Paystack. Follow the payment instructions shown during checkout.',
  },
  {
    question: 'How can I track my shipment from China to Nigeria?',
    answer:
      'Go to Orders and click on your order to view your order status and available shipment updates. As your goods move from factory preparation to international freight, customs clearance, and local dispatch, updates are displayed on your order detail page.',
  },
  {
    question: 'What should I do if my sourcing offer expired?',
    answer:
      'Sourcing offers have a validity window due to fluctuating currency exchange rates and factory prices. If an offer expires, you can contact our support team on WhatsApp to request a refreshed quote.',
  },
];
      ...
      <div className="mx-auto max-w-4xl space-y-8 px-4 py-6">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Have questions about your sourcing requests, orders, payments, or
            delivery? We are here to help you every step of the way.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="border-b border-border pb-3">
            ...
            <p className="text-xs text-muted-foreground">
              Everything you need to know about purchasing and sourcing with
              Africhina Connect.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="flex items-start gap-3 rounded-xl border border-border bg-card p-4">
              <Search size={18} className="mt-0.5 shrink-0 text-primary" />
              <div>
                <h3 className="text-sm font-semibold text-foreground">
                  Custom Sourcing & Offers
                </h3>
                <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                  Submit product requests for goods not in our catalogue. We
                  negotiate factory prices and provide transparent door-to-door
                  quotations.
                </p>
                <Link
                  href="/rfq"
